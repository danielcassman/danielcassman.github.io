...
Upon installing the Nvidia drivers, my machine would hang with a blank screen and blinking cursor whenever I tried to shut it down. I fixed this by editing the /etc/default/grub file and adding **acpi_rev_override=1" to the GRUB_CMDLINE_LINUX_DEFAULT parameters [\[Source\]](https://askubuntu.com/questions/951415/ubuntu-16-04-hangs-on-shutdown-restart)
